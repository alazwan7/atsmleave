    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Access Techno Solution Malaysia Sdn. Bhd.</strong><br>
            Bethany<br>
            6964 Ralph Street<br>
            Website: www.atsm.com.my<br>
            Email: admin@atsm.my
          </address>
        </div>
        <!-- /.col -->
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>RM <?php echo $cnt['basic_salary']; ?></td>
                <td>RM <?php echo $cnt['allowance']; ?></td>
                <td>RM <?php echo $cnt['total']; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
